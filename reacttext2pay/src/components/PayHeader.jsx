...
class PayHeader extends Component{
 ...
 getUserInfo(tempEmail){
  ...
  render(){   
    ...
    return(
      <div>
        <img class="card-img-top" src={Woodstocks} alt="Card image cap"style={{width:"100px",height:"100px",borderRadius:"50px",marginTop:"40px"}}></img>
        <h1 className="card-title" style = {{fontSize:"25px",marginTop: "5px"}}>{this.state.user}</h1>
