...
class RequestCard extends Component {
  ...
  createRequest() {
    ...
    var obj = {
      body: "https://www.thegrandpotato.com/pay/" + paymentRequestID
    };
      ...
      db.collection("paymentRequests")
        ...
        .then(function(docRef) {
          ...
          currentComp.setState({
            status: "requested",
            requestLink:
              "https://www.thegrandpotato.com/pay/" + paymentRequestID
          });
  ...
  getUserEmail() {
    ...
    firebase.auth().onAuthStateChanged(function(user) {
      if (user) {
        ...
        // console.log(email)
        currentComp.setState({ status: "updated", email: email });
      }
    });
  }
  ...
  render() {
    ...
    if (this.state.status == "updated") {
      ...
      this.instructionText =
        "Please scan or check text to complete the request.";
    }
    return (
      <div
        className="card"
        style={{
          ...
          visibility: this.state.status == "empty" ? "hidden" : "visible"
        }}
      >
        <div className="card-body" style={{ width: "500px", height: "250px" }}>
          ...
          <p
            className="card-text"
            style={{ fontSize: "16px", textAlign: "center", marginTop: "25px" }}
          >
            {this.instructionText}
          </p>
          <input
            ...
            style={{
              ...
              visibility:
                this.state.status == "requested" ? "hidden" : "visible"
            }}
          />
          <input
            id="phoneNumber"
          ...
          <QRCode
            ...
            style={{
              ...
              marginBottom: "25px",
              visibility:
                this.state.status == "requested" ? "visible" : "hidden"
            }}
          />
          <br />
          <a
